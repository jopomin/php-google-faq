...
<head>
    ...
    <title>PHP GOOGLE FAQs - 26 Aprile</title>
</head>
<body>
    <?php
    $faqs = [
        [
            ...
            "Header" => "Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?",
        ...
        [
            "Header" => "Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?",
        ...
        [
            "Header" => "Perché il mio account è associato a un paese?",
        ...
        [
            "Header" => "Stabilire il paese associato al tuo account",
        ...
        [
            "Header" => "Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?",
        ...
        [
            "Header" => "Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?",
    ...
    <header>
        <div id="top_header">
            <div id="top_lf_head">
                ...
                <h1><a>Privacy e Termini</a></h1>
            </div>
            <div id="top_rg_head">
                <div id="menu_points"></div>
        ...
        <div class="main_container">
            <?php
                for ($i = 0; $i < count($faqs); $i++) {
                    echo "<h2>" .$faqs[$i]["Header"] ."</h2>";
                    foreach ($faqs[$i]["Paragrafi"] as $par) {
                        echo "<p>" .$par ."</p>";
                    }
                }
            ?>
    ...
    <footer>
        ...
        <div id="ft_menu">
            <div id="ft_contact_us"></div>
            <div id="ft_language"></div>
        </div>
    </footer>
